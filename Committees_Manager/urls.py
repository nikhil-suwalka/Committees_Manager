...
urlpatterns = [
    ...
    path('viewRegisteredEvents/', viewRegisteredEvents, name="viewRegisteredEvents"),
    ...
    path('club/<int:club_id>/event/<int:event_id>/form', viewEventForms, name="viewEventForms"),
    path('club/<int:club_id>/event/<int:event_id>/form/create', createEventForm, name="createEventForm"),
    path('club/<int:club_id>/event/<int:event_id>/form/<int:form_id>', fillEventForm, name="fillEventForm"),
    path('club/<int:club_id>/event/<int:event_id>/form/<int:form_id>/delete', deleteEventForm, name="deleteEventForm"),
    path('club/<int:club_id>/event/<int:event_id>/stats', statsEvent, name="statsEvent"),
